...
N2O4 <---> 2NO2
Forward reaction rate law: rate = k1\[N2O4]

Backward reaction rate law: k-1 \[NO2]^2
...
- The reactions happen at the same rate
frrl = brrl
K1/K-1 = frrl/brrl = Kc which is the equilibrium constant
...
If Kc >> 1 then All products A--->B
If Kc << 1 then All reactants no reaction
...
water is a constant value of ~55.6
you can just multiply and absorb into the constant so you only have one thing on the bottom

Kp = pressure equilibrium constant
Kp = Pso2 squared Po2/ Pso3 squared
